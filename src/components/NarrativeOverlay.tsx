...
export function NarrativeOverlay({ scenes, activeScene, state, onChestTap, onOpenCredits }: NarrativeOverlayProps) {
  ...
  return (
    <div className="narrative-layer">
      ...
      <div className="loader-copy" aria-hidden={activeScene !== "loader"}>
        <div className="loader-copy__motion" data-loader-copy>
        ...
        {storyScenes.map((scene) => {
          ...
          return (
            <article
              ...
              key={scene.id}
            >
              <div className="scene-copy__motion" data-scene-copy>
